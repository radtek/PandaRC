...
//  m_userInput = new WindowsUserInput(this, ctrlAltDelEnabled, glog);
//
...
//{
//glog.debug(_T("The UserInputServer destructor has been called"));
//  delete m_userInput;
//}
//
...
//    }
//  } catch (Exception &e) {
//    glog.error(_T("An error has been occurred while sending a")
