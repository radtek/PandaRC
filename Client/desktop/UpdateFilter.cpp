...
void UpdateFilter::filter(UpdateContainer *updateContainer)
{
	...
	//XLog(LEVEL_DEBUG, ("Before grabbing region %f processor Mcycles, %f process time, %f kernel time, %f wall clock time "),
	//	pt1.cycle / 1000000., pt1.process, pt1.kernel, pt1.wall.getTime());
	//XLog(LEVEL_DEBUG, ("After grabbing region Mpoint grabbed: %f for %f processor Mcycles. %f ms"),
	//	area, pt2.cycle / 1000000., dt);
	//XLog(LEVEL_DEBUG, ("After grabbing region %f process time, %f kernel time, %f wall clock time"), pt2.process, pt2.kernel, dt);

	//XLog(LEVEL_DEBUG, ("end of grabbing region"));
	...
	//XLog(LEVEL_DEBUG, ("Before filtering changed %f processor Mcycles, %f process time, %f kernel time, %f wall clock time "),
	//	pt1.cycle / 1000000., pt1.process, pt1.kernel, pt1.wall.getTime());
	//XLog(LEVEL_DEBUG, ("After filtering changed Mpoint filtered: %f for %f processor Mcycles. %f ms"),
	//	area, pt2.cycle / 1000000., dt);
	//XLog(LEVEL_DEBUG, ("After filtering changed %f process time, %f kernel time, %f wall clock time"), pt2.process, pt2.kernel, dt);
}
