...
enet_peer_queue_incoming_command (ENetPeer * peer, const ENetProtocol * command, const void * data, size_t dataLength, enet_uint32 flags, enet_uint32 fragmentCount)
{
	...
	{
		//printf("enet_peer_queue_incoming_command 00\n");
		goto discardCommand;
	}
	...
	if ((command -> header.command & ENET_PROTOCOL_COMMAND_MASK) != ENET_PROTOCOL_COMMAND_SEND_UNSEQUENCED)
	{
		...
		if (reliableWindow < currentWindow || reliableWindow >= currentWindow + ENET_PEER_FREE_RELIABLE_WINDOWS - 1)
		{
			//printf("enet_peer_queue_incoming_command 01\n");
			goto discardCommand;
		}
	}
	...
	switch (command -> header.command & ENET_PROTOCOL_COMMAND_MASK)
	{
		...
		case ENET_PROTOCOL_COMMAND_SEND_RELIABLE:
			if (reliableSequenceNumber == channel -> incomingReliableSequenceNumber)
			{
				//printf("enet_peer_queue_incoming_command 02\n");
				goto discardCommand;
			}
					...
					currentCommand = enet_list_previous (currentCommand))
			{
				...
				if (incomingCommand -> reliableSequenceNumber <= reliableSequenceNumber)
				{
					...
					//printf("enet_peer_queue_incoming_command 03\n");
					goto discardCommand;
				}
			}
			break;
		...
		case ENET_PROTOCOL_COMMAND_SEND_UNRELIABLE_FRAGMENT:
			...
			{
				//printf("enet_peer_queue_incoming_command 04\n");
				goto discardCommand;
			}
					...
					currentCommand = enet_list_previous (currentCommand))
			{
				...
				if (incomingCommand -> unreliableSequenceNumber <= unreliableSequenceNumber)
				{
					...
					//printf("enet_peer_queue_incoming_command 05\n");
					goto discardCommand;
				}
			}
			break;
		...
		default:
			//printf("enet_peer_queue_incoming_command 06\n");
			goto discardCommand;
	}

	if (peer -> totalWaitingData >= peer -> host -> maximumWaitingData)
	{
		//printf("enet_peer_queue_incoming_command 10\n");
		goto notifyError;
	}
	...
	if (packet == NULL)
	{
		//printf("enet_peer_queue_incoming_command 11\n");
		goto notifyError;
	}
	...
	{
		//printf("enet_peer_queue_incoming_command 12\n");
		goto notifyError;
	}
	...
	{ 
		...
		if (incomingCommand -> fragments == NULL)
		{
			...
			//printf("enet_peer_queue_incoming_command 13\n");
			goto notifyError;
		}
...
discardCommand:
	if (fragmentCount > 0)
	{
		//printf("enet_peer_queue_incoming_command 14\n");
		goto notifyError;
	}
